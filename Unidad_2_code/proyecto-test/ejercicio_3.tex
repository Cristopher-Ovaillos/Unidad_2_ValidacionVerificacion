...
\begin{itemize}
    ...
    \item Paso 3: Construir la suite heredada, un caso de prueba por cada combinacion metodo por clase de dequivalencia de entrada (\ref{tab:ce_asignar} y \ref{tab:ce_liberar}.)
\end{itemize}
...
Código fuente (clases del dominio): \href{https://github.com/Cristopher-Ovaillos/Unidad_2_ValidacionVerificacion/tree/main/Unidad_2_code/proyecto-test/src/main/java/com/ejercicio_2/}{\texttt{proyecto-test/src/main/java/}} \\
Suite Heredada (test abstracto): \href{https://github.com/Cristopher-Ovaillos/Unidad_2_ValidacionVerificacion/blob/main/Unidad_2_code/proyecto-test/src/test/java/com/ejercicio_2/VehiculoTest.java}{\texttt{VehiculoTest.java}} \\
Tests por subclase: \href{https://github.com/Cristopher-Ovaillos/Unidad_2_ValidacionVerificacion/blob/main/Unidad_2_code/proyecto-test/src/test/java/com/ejercicio_2/TestAutoHeredado.java}{\texttt{TestAutoHeredado.java}}, \href{https://github.com/Cristopher-Ovaillos/Unidad_2_ValidacionVerificacion/blob/main/Unidad_2_code/proyecto-test/src/test/java/com/ejercicio_2/TestMotoHeredadi.java}{\texttt{TestMotoHeredadi.java}}, \href{https://github.com/Cristopher-Ovaillos/Unidad_2_ValidacionVerificacion/blob/main/Unidad_2_code/proyecto-test/src/test/java/com/ejercicio_2/TestCamionHeredado.java}{\texttt{TestCamionHeredado.java}}
...
\begin{itemize}
    \item \texttt{Pre_D}: $kmEstimados > 0 \land kmEstimados \le 500 \land estado == DISPONIBLE$ (Igual a la superclase).
    \item \texttt{Post_D}: $estado == EN\_USO \land \text{retorno} \neq null$ (Mantiene la promesa del padre).
    \item \texttt{invariante_D}: $kmActuales \ge 0 \land numPuertas > 0$.
\end{itemize}

\textbf{Tests específicos de Auto:} Para esta subclase se agregan pruebas de unidad que no son polimórficas (no están en la suite heredada), como la verificación de la cantidad de puertas en el constructor o métodos específicos si existieran.
